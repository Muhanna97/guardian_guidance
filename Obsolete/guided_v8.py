...
class gotoGuardian3(mthread.MicroThread):
    ...
    def go(self):
        ...
        if (targetDistance > 20): # if we're far from main target and have reached intermediate location, send another one
            print "velocity control"
            bearing = self.getBearingGood(vehicle.location.global_relative_frame,targetLoc)
            ...
            northVelocity = defaultVelocity*northScale*distanceScale
            eastVelocity = defaultVelocity*eastScale*distanceScale

            print northVelocity," ,", eastVelocity
